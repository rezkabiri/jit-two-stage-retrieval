...
3.  **Prefix Routing**: When using Vertex AI, the system automatically prepends the `vertex-ai/` prefix to the model identifier, ensuring the ADK correctly initializes the Vertex AI generative model client.
